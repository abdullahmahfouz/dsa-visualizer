 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function t(T,_){var z=T.length;T.push(_);e:for(;0<z;){var F=z-1>>>1,B=T[F];if(0<i(B,_))T[F]=_,T[z]=B,z=F;else break e}}function r(T){return T.length===0?null:T[0]}function s(T){if(T.length===0)return null;var _=T[0],z=T.pop();if(z!==_){T[0]=z;e:for(var F=0,B=T.length,I=B>>>1;F<I;){var V=2*(F+1)-1,P=T[V],w=V+1,H=T[w];if(0>i(P,z))w<B&&0>i(H,P)?(T[F]=H,T[w]=z,F=w):(T[F]=P,T[V]=z,F=V);else if(w<B&&0>i(H,z))T[F]=H,T[w]=z,F=w;else break e}}return _}function i(T,_){var z=T.sortIndex-_.sortIndex;return z!==0?z:T.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;n.unstable_now=function(){return a.now()}}else{var l=Date,o=l.now();n.unstable_now=function(){return l.now()-o}}var c=[],d=[],u=1,h=null,g=3,b=!1,N=!1,y=!1,j=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(T){for(var _=r(d);_!==null;){if(_.callback===null)s(d);else if(_.startTime<=T)s(d),_.sortIndex=_.expirationTime,t(c,_);else break;_=r(d)}}function C(T){if(y=!1,x(T),!N)if(r(c)!==null)N=!0,L(v);else{var _=r(d);_!==null&&$(C,_.startTime-T)}}function v(T,_){N=!1,y&&(y=!1,f(D),D=-1),b=!0;var z=g;try{for(x(_),h=r(c);h!==null&&(!(h.expirationTime>_)||T&&!q());){var F=h.callback;if(typeof F=="function"){h.callback=null,g=h.priorityLevel;var B=F(h.expirationTime<=_);_=n.unstable_now(),typeof B=="function"?h.callback=B:h===r(c)&&s(c),x(_)}else s(c);h=r(c)}if(h!==null)var I=!0;else{var V=r(d);V!==null&&$(C,V.startTime-_),I=!1}return I}finally{h=null,g=z,b=!1}}var R=!1,S=null,D=-1,M=5,E=-1;function q(){return!(n.unstable_now()-E<M)}function K(){if(S!==null){var T=n.unstable_now();E=T;var _=!0;try{_=S(!0,T)}finally{_?O():(R=!1,S=null)}}else R=!1}var O;if(typeof m=="function")O=function(){m(K)};else if(typeof MessageChannel<"u"){var A=new MessageChannel,k=A.port2;A.port1.onmessage=K,O=function(){k.postMessage(null)}}else O=function(){j(K,0)};function L(T){S=T,R||(R=!0,O())}function $(T,_){D=j(function(){T(n.unstable_now())},_)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(T){T.callback=null},n.unstable_continueExecution=function(){N||b||(N=!0,L(v))},n.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<T?Math.floor(1e3/T):5},n.unstable_getCurrentPriorityLevel=function(){return g},n.unstable_getFirstCallbackNode=function(){return r(c)},n.unstable_next=function(T){switch(g){case 1:case 2:case 3:var _=3;break;default:_=g}var z=g;g=_;try{return T()}finally{g=z}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(T,_){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var z=g;g=T;try{return _()}finally{g=z}},n.unstable_scheduleCallback=function(T,_,z){var F=n.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?F+z:F):z=F,T){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=z+B,T={id:u++,callback:_,priorityLevel:T,startTime:z,expirationTime:B,sortIndex:-1},z>F?(T.sortIndex=z,t(d,T),r(c)===null&&T===r(d)&&(y?(f(D),D=-1):y=!0,$(C,z-F))):(T.sortIndex=B,t(c,T),N||b||(N=!0,L(v))),T},n.unstable_shouldYield=q,n.unstable_wrapCallback=function(T){var _=g;return function(){var z=g;g=_;try{return T.apply(this,arguments)}finally{g=z}}}})(Tu);Cu.exports=Tu;var Of=Cu.exports;/**
 * @license React
