...
import hashtableChainingConcepts from '../data/concepts/hashtable_chaining.json';
import hashtableQuadraticConcepts from '../data/concepts/hashtable_quadratic.json';
